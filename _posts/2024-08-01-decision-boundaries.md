...
![Header Image]({{ '/images/neural-nets/header-image.png' | relative_url }}){: width="85%"}
...
![Introduction]({{ '/images/neural-nets/nn-task-intro.png' | relative_url }}){: width="85%"}
...
![All Models]({{ '/images/neural-nets/nn-all-three.png' | relative_url }}){: width="85%"}
...
![Logistic Regression]({{ '/images/neural-nets/nn-log-regression.png' | relative_url }}){: width="85%"}
...
![Simple Random Forest]({{ '/images/neural-nets/nn-rf.png' | relative_url }}){: width="85%"}
...
![Complex Random Forest]({{ '/images/neural-nets/nn-rf-strong.png' | relative_url }}){: width="85%"}
...
![Base Neural Network]({{ '/images/neural-nets/nn-nn-weak.png' | relative_url }}){: width="85%"}
...
![Tuned Neural Network]({{ '/images/neural-nets/nn-nn-strong.png' | relative_url }}){: width="85%"}
...
![Neural Network Demo]({{ '/images/neural-nets/nn-nn-demo.png' | relative_url }}){: width="85%"}
...
https://github.com/chrismca13
https://www.linkedin.com/in/chris-mcallister-b7597710b/